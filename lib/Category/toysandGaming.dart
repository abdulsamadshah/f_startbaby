...
class ToysandGaming extends StatefulWidget {
  const ToysandGaming({Key? key}) : super(key: key);

  @override
  State<ToysandGaming> createState() => _ToysandGaming();
}

class _ToysandGaming extends State<ToysandGaming> {
              ...
              children: [
                Expanded(
                  child: FirebaseAnimatedList(
                    query: babygearref.ref.child("ToysGaming"),
