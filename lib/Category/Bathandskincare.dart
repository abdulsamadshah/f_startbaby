...
class Bathandskincare extends StatefulWidget {
  const Bathandskincare({Key? key}) : super(key: key);

  @override
  State<Bathandskincare> createState() => _Bathandskincare();
}

class _Bathandskincare extends State<Bathandskincare> {
              ...
              children: [
                Expanded(
                  child: FirebaseAnimatedList(
                    query: babygearref.ref.child("Bathandskincare"),
