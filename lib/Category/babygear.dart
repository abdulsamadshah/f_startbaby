...
class Babygearproduct extends StatefulWidget {
  const Babygearproduct({Key? key}) : super(key: key);

  @override
  State<Babygearproduct> createState() => _Babygearproduct();
}

class _Babygearproduct extends State<Babygearproduct> {
              ...
              children: [
                Expanded(
                  child: FirebaseAnimatedList(
                    query: babygearref.ref.child("BabyGear"),
                                        ...
                                        Align(
                                          ...
                                          child: InkWell(
                                            onTap: () {
                                              ...
                                              print(
                                                  "babygearproductid:${student['productid']}");
                                              int cartid = DateTime.now()
                                                  .microsecondsSinceEpoch;
                                              mycart
                                                  .child(cartid.toString())
                                                  .set({
